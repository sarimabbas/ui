...
const toggleVariants = cva(
  "inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors hover:bg-stone-100 hover:text-stone-500 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-stone-400 disabled:pointer-events-none disabled:opacity-50 data-[state=on]:bg-stone-100 data-[state=on]:text-stone-900 dark:hover:bg-stone-800 dark:hover:text-stone-400 dark:focus-visible:ring-stone-800 dark:data-[state=on]:bg-stone-800 dark:data-[state=on]:text-stone-50",
  {
    variants: {
      variant: {
